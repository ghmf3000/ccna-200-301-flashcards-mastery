...
const AppInner: React.FC = () => {
  ...
  const [attemptedDeckName, setAttemptedDeckName] = useState<string | null>(
    null
  );
  ...
  // 1) Initial Load - Data + Stripe success/cancel
  useEffect(() => {
  ...
  // 2) Load mastery from LocalStorage
  useEffect(() => {
  ...
  // ✅ Clerk → build your internal user session
  useEffect(() => {
    if (!isLoaded) return;
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col select-none">
      ...
      {toast && (
        <div
          className={`fixed bottom-8 left-1/2 -translate-x-1/2 z-[100] px-6 py-3 rounded-2xl shadow-2xl font-bold text-white ${
          ...
          <div className="bg-white p-8 rounded-[2.5rem] shadow-2xl max-w-md w-full">
            <div className="text-center mb-6">
              ...
              <p className="text-slate-500 text-sm mt-2">
                Sign in to track mastery and unlock Pro.
              </p>
            </div>
            <SignIn routing="hash" />
          </div>
            ...
            <div className="max-w-6xl mx-auto px-4 w-full flex justify-between items-center">
              <div className="flex items-center gap-3">
                {(view !== "domainSelect" && view !== "paywall") && (
                  <button
                    onClick={() =>
                      setView(view === "study" ? "deckSelect" : "domainSelect")
                    }
            ...
            <div className="flex justify-between items-end mb-8">
              <div>
                ...
                <p className="text-slate-500 font-medium">
                  Welcome back! Accessing {cards.length} cards across {decks.length} decks.
                </p>
              </div>
            </div>
                ...
                return (
                  ...
                  >
                    <div
                      ...
                      style={{ width: progress + "%", backgroundColor: progress === 100 ? "#22c55e" : color }}
                    />
          ...
          <main className="flex-1 max-w-2xl mx-auto p-6 w-full">
            ...
            <div className="space-y-4">
              {domainDecksList.map((deck) => {
                ...
                const deckMasteredCount = cards.filter(
                  (c) => c.deck_id === deck.deck_id && masteredIds.has(c.card_id)
                ).length;
              ...
              <div className="w-full max-w-lg space-y-8 flex flex-col items-center">
                  ...
                  <div className="flex justify-between items-end">
                    ...
                    <div className="flex items-center gap-4 flex-shrink-0">
                      <button
                        ...
                        className={`text-[10px] font-black uppercase tracking-widest px-2.5 py-1.5 rounded transition-all transform active:scale-95 ${
                          isShuffled
                ...
                <div className="flex items-center gap-8 pb-10">
                  <button
                    ...
                    className="p-5 bg-white rounded-full shadow-lg text-slate-400 hover:text-blue-600 hover:scale-110 transition-all active:scale-90 border border-slate-100"
                  >
            ...
            <div className="bg-white p-10 rounded-[3rem] shadow-2xl max-w-md w-full text-center space-y-8 border border-amber-100">
              ...
              <div>
                ...
                <p className="text-slate-500 font-medium mt-2 leading-relaxed">
                  ...
                  is part of CCNA Mastery Pro. Unlock all premium content and advanced AI tutoring today.
                </p>
              </div>
...
// -----------------------------
// Exported root with ClerkProvider
// -----------------------------
const App: React.FC = () => {
  return (
